...
final class RhythmSettings {
    ...
    /** The per-hit judgment feedback at the judge line — BURST (radiating sparks, shown to
     *  players as "폭죽 파티클"/"Firework Particles", the default) or RIPPLE (water rings
