...
enum Lang {
    ...
    private static final Map<String, String[]> TABLE = Map.ofEntries(
            ...
            Map.entry("hub.tempoUp", new String[]{"템포 업", "Tempo Up", "テンポアップ", "节奏加速"}),
            ...
            Map.entry("settings.noteStyle.ring", new String[]{"니아의 게임월드", "Niah's Game World", "ニアのゲームワールド", "尼雅的游戏世界"}),
            ...
            Map.entry("settings.laneLayout", new String[]{"레인 구조", "Lane layout", "レーン構造", "轨道结构"}),
            Map.entry("settings.laneLayout.flat", new String[]{"평면형", "Flat", "平面型", "平面型"}),
            Map.entry("settings.laneLayout.perspective", new String[]{"입체 원근형", "Perspective", "立体遠近型", "立体透视型"}),
